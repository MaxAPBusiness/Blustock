# Form implementation generated from reading ui file 'c:\Users\Maximo\Documents\Blustock\blustock\ui\screens_uis\movimientos.ui'
#
...
"")
        ...
        self.label_2.setPixmap(QtGui.QPixmap("c:\\Users\\Maximo\\Documents\\Blustock\\blustock\\ui\\screens_uis\\lupa.png"))
    ...
    def retranslateUi(self, Form):
        ...
        item.setText(_translate("Form", "Persona"))
        item = self.tableWidget.horizontalHeaderItem(6)
        item.setText(_translate("Form", "Motivo"))
        item = self.tableWidget.horizontalHeaderItem(7)
        item.setText(_translate("Form", "Fecha y Hora"))
        item = self.tableWidget.horizontalHeaderItem(8)
        item.setText(_translate("Form", "Turno"))
        item = self.tableWidget.horizontalHeaderItem(9)
        item.setText(_translate("Form", "Ubicación"))
        item = self.tableWidget.horizontalHeaderItem(10)
        item.setText(_translate("Form", "Pañorelo"))
        item = self.tableWidget.horizontalHeaderItem(11)
        item.setText(_translate("Form", "Profesor a cargo del turno"))
