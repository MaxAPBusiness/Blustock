...
m.descripcion, p.nombre_apellido || ' ' || c.descripcion, m.fecha_hora, m.id_turno, u.descripcion,
pa.nombre_apellido || ' ' || c.descripcion,
pr.nombre_apellido
FROM movimientos m
...
AND pa.nombre_apellido || ' ' || c.descripcion LIKE ?
AND (m.id_turno LIKE ?
